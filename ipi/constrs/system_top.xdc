...
set_clock_groups -name async_0 -asynchronous -group [get_clocks clk_fpga_0] -group [get_clocks video_clk]
set_clock_groups -name async_1 -asynchronous -group [get_clocks clk_fpga_1] -group [get_clocks video_clk]
set_clock_groups -name async_2 -asynchronous -group [get_clocks clk_fpga_0] -group [get_clocks clk_fpga_1]
