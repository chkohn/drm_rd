...
BEGIN DRIVER
 ...
 PARAMETER HW_INSTANCE = video_capture_v_tpg_1
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = axivdma
 PARAMETER DRIVER_VER = 4.05.a
 PARAMETER HW_INSTANCE = video_display_axi_vdma_2
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = cresample
 PARAMETER DRIVER_VER = 2.00.a
 PARAMETER HW_INSTANCE = video_display_v_cresample_1
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = osd
 PARAMETER DRIVER_VER = 2.00.a
 PARAMETER HW_INSTANCE = video_display_v_osd_1
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = rgb2ycrcb
 PARAMETER DRIVER_VER = 5.01.a
 PARAMETER HW_INSTANCE = video_display_v_rgb2ycrcb_1
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = vtc
 PARAMETER DRIVER_VER = 4.00.a
 PARAMETER HW_INSTANCE = video_display_v_tc_1
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = axivdma
 PARAMETER DRIVER_VER = 4.05.a
 PARAMETER HW_INSTANCE = video_processing_axi_vdma_m2m
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = sobel_filter_top
 PARAMETER DRIVER_VER = 1.05.a
 PARAMETER HW_INSTANCE = video_processing_sobel_filter_1
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = axivdma
 PARAMETER DRIVER_VER = 4.05.a
 PARAMETER HW_INSTANCE = video_display_axi_vdma_3
END
...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = vtc
 PARAMETER DRIVER_VER = 4.00.a
 PARAMETER HW_INSTANCE = video_capture_v_tc_1
END
...
BEGIN LIBRARY
 PARAMETER LIBRARY_NAME = gpiops_adapter
 PARAMETER LIBRARY_VER = 1.00.a
 PARAMETER PROC_INSTANCE = ps7_cortexa9_0
END
