...
module sobel_filter_OUTPUT_STREAM_if (
    ...
    // User signals
    input  wire [15:0] out_pix_data_V_din,
    output wire        out_pix_data_V_full_n,
    input  wire        out_pix_data_V_write,
    input  wire [1:0]  out_pix_strb_V_din,
...
wire [15:0] out_pix_data_V_dout;
wire [0:0]  out_pix_data_V_empty_n;
wire [1:0]  out_pix_strb_V_dout;
...
assign TSTRB  = m_data[17:16];
assign TUSER  = m_data[18:18];
assign TLAST  = m_data[19:19];
assign TDEST  = m_data[20:20];
