...
module sobel_filter_INPUT_STREAM_if (
    ...
    // User signals
    output wire [15:0] inter_pix_data_V_dout,
    output wire        inter_pix_data_V_empty_n,
    input  wire        inter_pix_data_V_read,
    output wire [1:0]  inter_pix_strb_V_dout,
...
wire [15:0] inter_pix_data_V_din;
wire [0:0]  inter_pix_data_V_full_n;
wire [1:0]  inter_pix_strb_V_din;
...
assign s_data  = {TDEST[0:0], TLAST[0:0], TUSER[0:0], TSTRB[1:0], TDATA[15:0]};

//+++++++++++++++++++++++++++++++++++++++++++++++++++++++

//++++++++++++++++++++++++FIFO+++++++++++++++++++++++++++
assign fifo_write            = fifo_full_n & m_valid;
assign inter_pix_data_V_din  = m_data[15:0];
assign inter_pix_strb_V_din  = m_data[17:16];
assign inter_pix_user_V_din  = m_data[18:18];
assign inter_pix_last_V_din  = m_data[19:19];
assign inter_pix_tdest_V_din = m_data[20:20];
