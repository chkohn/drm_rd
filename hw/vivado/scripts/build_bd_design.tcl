...
proc create_hier_cell_video_capture { parentCell nameHier } {
  ...
  set_property -dict [ list CONFIG.has_axi4s_slave {false} CONFIG.pattern_control {9} CONFIG.enable_motion {true}  ] $v_tpg_1
...
proc create_hier_cell_video_display { parentCell nameHier } {
  ...
  set_property -dict [ list CONFIG.HAS_INTC_IF {false} CONFIG.NUMBER_OF_LAYERS {3} CONFIG.SCREEN_WIDTH {1920} CONFIG.S_AXIS_VIDEO_FORMAT {YUV_422} CONFIG.M_AXIS_VIDEO_WIDTH {1920} CONFIG.M_AXIS_VIDEO_HEIGHT {1080} CONFIG.LAYER0_ENABLE {false} CONFIG.LAYER1_ENABLE {false} CONFIG.LAYER1_GLOBAL_ALPHA_VALUE {255}  ] $v_osd_1
  ...
  connect_bd_net -net hdmi_clk_1 [get_bd_pins vid_io_out_clk] [get_bd_pins v_axi4s_vid_out_1/vid_io_out_clk] [get_bd_pins v_tc_1/clk]
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list CONFIG.PCW_FPGA0_PERIPHERAL_FREQMHZ {100} CONFIG.PCW_FPGA1_PERIPHERAL_FREQMHZ {50} CONFIG.PCW_USE_S_AXI_HP0 {1} CONFIG.PCW_USE_S_AXI_HP2 {1} CONFIG.PCW_USE_FABRIC_INTERRUPT {1} CONFIG.PCW_EN_CLK1_PORT {0} CONFIG.PCW_IRQ_F2P_INTR {1} CONFIG.PCW_IMPORT_BOARD_PRESET {ZC706}  ] $processing_system7_1
  ...
  set_property -dict [ list CONFIG.NUM_PORTS {10}  ] $pl_interrupts
  ...
  set_property -dict [ list CONFIG.NUM_MI {11}  ] $axi_interconnect_gp0
...
connect_bd_intf_net -intf_net axi_interconnect_hp1_m00_axi [get_bd_intf_pins axi_interconnect_hp2/M00_AXI] [get_bd_intf_pins axi_perf_mon_1/SLOT_1_AXI]
  ...
  connect_bd_net -net hdmi_clk_1 [get_bd_ports video_clk] [get_bd_ports hdmio_clk] [get_bd_pins video_display/vid_io_out_clk]
