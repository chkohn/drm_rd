...
proc create_hier_cell_video_capture { parentCell nameHier } {
  ...
  connect_bd_net -net clk_1 [get_bd_pins clk] [get_bd_pins vtiming_mux_1/video_clk_2]
  ...
  connect_bd_net -net vtiming_mux_1_video_clk [get_bd_pins vtiming_mux_1/video_clk] [get_bd_pins v_tc_1/clk] [get_bd_pins v_vid_in_axi4s_1/vid_io_in_clk] [get_bd_pins fmc_imageon_hdmi_in_1/clk]
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list CONFIG.FREQ_HZ {148500000} CONFIG.PHASE {0.000} CONFIG.CLK_DOMAIN {system_hdmi_clk}  ] $hdmio_clk
...
connect_bd_intf_net -intf_net axi_interconnect_hp1_m00_axi [get_bd_intf_pins axi_interconnect_hp2/M00_AXI] [get_bd_intf_pins axi_perf_mon_1/SLOT_1_AXI]
  ...
  connect_bd_net -net hdmi_clk_1 [get_bd_ports video_clk] [get_bd_ports hdmio_clk] [get_bd_pins video_display/vid_io_out_clk] [get_bd_pins video_capture/video_clk_2]
  ...
  connect_bd_net -net video_display_vid_hsync [get_bd_ports hdmio_hsync] [get_bd_pins video_display/vid_hsync]
  connect_bd_net -net video_display_vid_active_video [get_bd_ports hdmio_de] [get_bd_pins video_display/vid_active_video]
  connect_bd_net -net video_display_vid_vsync [get_bd_ports hdmio_vsync] [get_bd_pins video_display/vid_vsync]
  connect_bd_net -net video_display_vid_data [get_bd_ports hdmio_data] [get_bd_pins video_display/vid_data]
